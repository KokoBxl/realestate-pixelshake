...
(() => {
  ...
  const T = {
    fr: {
      ...
      'wc4.tag':   'Film interviews',
      'wc4.title': 'Architecte &amp; promoteur — Interview',
      'wc4.sub':   'Bruxelles · Film interviews · Projet résidentiel',
      'wc5.tag':   'Vente sur plan',
      'wc5.title': 'Matexi — Lancement commercial',
      'wc5.sub':   'Bruxelles · Film &amp; stratégie sociale',
      'wc6.tag':   'Timelapse',
      ...
      // Services
      'svc.label': 'Services',
      'svc.h2':    'Quatre <em>prestations</em><br/>en détail.',
      'svc.intro': 'Une section par type de prestation. Pour qui, pour quoi, comment.',
      'svc1.title': 'Film de présentation immobilier',
      'svc1.tag':   'Promoteur · Corporate · Brand',
      'svc1.p1':    "Un film de présentation immobilier n'est pas une plaquette animée. C'est l'occasion de montrer un projet, un promoteur ou un site industriel sous son meilleur angle — avec le bon rythme, la bonne lumière, et des images qui convainquent avant même la livraison.",
      ...
      'svc3.title': 'Quartier &amp; lancement de projet',
      'svc3.tag':   'Vente sur plan · Neighbourhood',
      'svc3.p1':    "Avant même la première pierre, un projet immobilier se vend sur la promesse d'un cadre de vie. Je produis l'ensemble des visuels qui donnent corps à cette promesse : film de quartier, vues aériennes du site, reportage photo ambiance, contenus réseaux sociaux adaptés à chaque canal.",
      'svc3.p2':    "Une approche intégrée — photo, vidéo, drone, stratégie sociale — pour faire vivre un projet en commercialisation bien avant sa livraison.",
      'svc4.title': 'Drone &amp; aérien',
      'svc4.tag':   'Pilote certifié',
      'svc4.p1':    "Pilote de drone certifié. Plans aériens pour chantiers, sites industriels, biens immobiliers, vue du quartier et du contexte urbain. Intégrés à une production photo/vidéo ou en prestation dédiée.",
      ...
      'why.1.h': 'Expérience',
      'why.1.p': "Depuis 2009, je produis pour des promoteurs immobiliers, des foncières, des constructeurs, des bureaux d'architecture et des industriels belges. La plupart reviennent. Certains sont là depuis plus de dix ans.",
    ...
    nl: {
      ...
      'wc4.tag':   'Interviewfilm',
      'wc4.title': 'Architect &amp; promotor — Interview',
      'wc4.sub':   'Brussel · Interviewfilm · Residentieel project',
      'wc5.tag':   'Verkoop op plan',
      'wc5.title': 'Matexi — Commerciële lancering',
      'wc5.sub':   'Brussel · Film &amp; sociale strategie',
      'wc6.tag':   'Timelapse',
      'wc6.title': 'AG Real Estate — Timelapse',
      ...
      // Services
      'svc.label': 'Diensten',
      'svc.h2':    'Vier <em>diensten</em><br/>in detail.',
      'svc.intro': 'Een sectie per type dienst. Voor wie, waarvoor, hoe.',
      'svc1.title': 'Presentatiefilm vastgoed',
      'svc1.tag':   'Promotor · Corporate · Brand',
      'svc1.p1':    'Een vastgoedpresentatiefilm is geen geanimeerde brochure. Het is de kans om een project, een promotor of een industriesite van zijn beste kant te tonen — met het juiste ritme, het juiste licht en beelden die overtuigen nog voor de oplevering.',
      ...
      'svc3.title': 'Wijk &amp; projectlancering',
      'svc3.tag':   'Verkoop op plan · Neighbourhood',
      'svc3.p1':    'Nog voor de eerste steen legt een vastgoedproject zichzelf te koop via de belofte van een leefomgeving. Ik produceer al het visuele materiaal dat die belofte concreet maakt: wijkfilm, luchtopnames van de site, sfeerreportage, sociale media-inhoud aangepast aan elk kanaal.',
      'svc3.p2':    'Een geïntegreerde aanpak — foto, video, drone, sociale strategie — om een project in commercialisatie tot leven te brengen, lang voor de oplevering.',
      'svc4.title': 'Drone &amp; luchtfoto',
      'svc4.tag':   'Gecertificeerde piloot',
      'svc4.p1':    'Gecertificeerde dronepiloot. Luchtopnames voor bouwplaatsen, industriesites, vastgoed, zicht op de wijk en de stedelijke context. Geïntegreerd in een foto/videoproductie of als afzonderlijke dienst.',
      ...
      'why.1.h': 'Ervaring',
      'why.1.p': 'Sinds 2009 produceer ik voor vastgoedpromotors, vastgoedfondsen, bouwers, architectenbureaus en Belgische industriëlen. De meesten komen terug. Sommigen zijn er al meer dan tien jaar.',
      'why.2.h': 'Anticipatie',
    ...
    en: {
      ...
      'wc4.tag':   'Interview film',
      'wc4.title': 'Architect &amp; developer — Interview',
      'wc4.sub':   'Brussels · Interview film · Residential project',
      'wc5.tag':   'Off-plan sales',
      'wc5.title': 'Matexi — Commercial launch',
      'wc5.sub':   'Brussels · Film &amp; social strategy',
      'wc6.tag':   'Timelapse',
      'wc6.title': 'AG Real Estate — Timelapse',
      ...
      // Services
      'svc.label': 'Services',
      'svc.h2':    'Four <em>services</em><br/>in detail.',
      'svc.intro': 'One section per service type. For whom, for what, how.',
      'svc1.title': 'Real estate presentation film',
      'svc1.tag':   'Developer · Corporate · Brand',
      'svc1.p1':    "A real estate presentation film is not an animated brochure. It's the opportunity to showcase a project, a developer or an industrial site at its best — with the right rhythm, the right light, and images that convince even before delivery.",
      ...
      'svc3.title': 'Neighbourhood &amp; project launch',
      'svc3.tag':   'Off-plan sales · Neighbourhood',
      'svc3.p1':    "Before the first stone is laid, a real estate project sells on the promise of a lifestyle. I produce all the visuals that give substance to that promise: neighbourhood film, aerial views of the site, atmospheric photo reportage, social media content tailored to each channel.",
      'svc3.p2':    "An integrated approach — photo, video, drone, social strategy — to bring a project to life during its commercialisation, well before delivery.",
      'svc4.title': 'Drone &amp; aerial',
      'svc4.tag':   'Certified pilot',
      'svc4.p1':    'Certified drone pilot. Aerial shots for construction sites, industrial sites, real estate properties, neighbourhood and urban context views. Integrated into a photo/video production or as a dedicated service.',
      ...
      'why.1.h': 'Experience',
      'why.1.p': "Since 2009, I've produced for real estate developers, property funds, builders, architecture firms and Belgian industrialists. Most come back. Some have been here for over ten years.",
      'why.2.h': 'Anticipation',
