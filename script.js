...
(() => {
  ...
  const T = {
    fr: {
      ...
      'hero.sub':             'Photo et vidéo pour entreprises, agences et promoteurs.<br class="d-br"/>Basé à Bruxelles, en activité depuis 2009.',
      ...
      'svc4.title': 'Événement &amp; aftermovie',
      'svc4.tag':   'Conférences · Soirées',
      'svc4.p1':    "Couverture photo et vidéo d'un même évènement, par une seule personne. Conférences, soirées clients, inaugurations, séminaires. Une première série de photos vous est livrée en direct pendant l'événement pour que vous puissiez communiquer immédiatement — réseaux sociaux, relations presse, posts live. La sélection complète et l'aftermovie suivent dans un délai convenu avec vous. Format adapté à votre usage final.",
    ...
    nl: {
      ...
      'hero.sub':             'Foto en video voor bedrijven, agentschappen en promotors.<br class="d-br"/>Gevestigd in Brussel, actief sinds 2009.',
      ...
      'svc4.title': 'Evenement &amp; aftermovie',
      'svc4.tag':   'Conferenties · Avonden',
      'svc4.p1':    'Foto- en videodekking van hetzelfde evenement, door één persoon. Conferenties, klantavonden, inhuldigingen, seminaries. Een eerste reeks foto\'s wordt live geleverd tijdens het evenement zodat u onmiddellijk kunt communiceren — sociale media, persrelaties, live posts. De volledige selectie en aftermovie volgen binnen een afgesproken termijn. Formaat aangepast aan uw eindgebruik.',
    ...
    en: {
      ...
      'hero.sub':             'Photo and video for companies, agencies and developers.<br class="d-br"/>Based in Brussels, active since 2009.',
      ...
      'svc4.title': 'Event &amp; aftermovie',
      'svc4.tag':   'Conferences · Evenings',
      'svc4.p1':    'Photo and video coverage of the same event, by one person. Conferences, client evenings, inaugurations, seminars. A first set of photos is delivered live during the event so you can communicate immediately — social media, press relations, live posts. The full selection and aftermovie follow within an agreed timeframe. Format adapted to your final use.',
